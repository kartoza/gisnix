...
| [`services-device`](#services-device)  | 2 | — | `services-device-input`, `services-device-mobile`, `services-device-peripherals`, `services-device-printing` |
...
| [`services-device-input`](#services-device-input)  | 5 | `services-device` | — |
